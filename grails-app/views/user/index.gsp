<%@ page import="com.intelligrape.pmi.UserRole; com.intelligrape.pmi.User" %>
<!DOCTYPE html>
<html>
<head>
        ...
        <div class="datatable-scroll">
            <table class="table table-bordered dataTable">
                ...
                <tr role="row">
                    ...
                    <g:sortableColumn class="sorting_asc" property="username"
                                      title="${message(code: 'user.username.label', default: 'Username')}"/>

                    <g:sortableColumn class="sorting_asc" property="Role"
                                      title="${message(code: 'userRole.role.label', default: 'Role')}"/>

                    <g:sortableColumn class="sorting_asc" property="accountExpired"
                                      title="${message(code: 'user.accountExpired.label', default: 'Account Expired')}"/>

                    <g:sortableColumn class="sorting_asc" property="accountLocked"
                                      title="${message(code: 'user.accountLocked.label', default: 'Account Locked')}"/>

                    <g:sortableColumn class="sorting_asc" property="enabled"
                                      title="${message(code: 'user.enabled.label', default: 'Enabled')}"/>

                    <g:sortableColumn class="sorting_asc" property="passwordExpired"
